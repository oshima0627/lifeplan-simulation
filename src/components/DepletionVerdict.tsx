      ...
      >
        ...
        <p className="mt-1 text-sm text-slate-700">
          {survivesAllScenarios
            ...
            : anyDepletes
              ? "打ち手は5つです。生活費を下げる / 収入を増やす / 利回り・期間を見直す / 想定外の支出を防ぐ / 支出の優先順位を見直す。左のフォーム（狭い画面では「入力する」ボタン）を変えてその場で試せます。"
              : "最終的には資産が残るものの、途中でマイナスの期間があります。この試算はマイナス残高を無利息で借り続けられる前提を置いているため、実際には取り崩す順序やタイミングの見直しが必要です。「強い計画」と言い切るにはまだ早く、左のフォーム（狭い画面では「入力する」ボタン）を変えて一時的な不足を解消できないか試してみてください。"}
        </p>
      </div>
